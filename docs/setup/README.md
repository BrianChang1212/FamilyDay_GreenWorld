...
詳細步驟自根目錄 [`README.md`](../../README.md) 移出，集中於此目錄，避免 README 過長。
...
| [`hosting-public-entry-urls.md`](./hosting-public-entry-urls.md) | **正式 Hosting**：報到／闖關入口 URL；**內建 QR PNG** 見 [`familyday-frontend/public/qr-entry-links/`](../../familyday-frontend/public/qr-entry-links/README.md)（**`npm run qr:entry-links`**） |
...
| [`ios-mobile-auth-fix-2026-05-13.md`](./ios-mobile-auth-fix-2026-05-13.md) | **iOS 跨網域登入**：由 Cookie 改 **Bearer + `sessionStorage`**；後端 **`authGuard`**／CORS **`Authorization`** 與 **`api-v0.1` v0.1.25–v0.1.26** 對齊 |
...
**索引：** 全庫文件導覽仍見 [`docs/README.md`](../README.md)。

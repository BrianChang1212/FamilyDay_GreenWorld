...
*README v3.00 · 2026-06-02(hotfix:正式 login + challenges 還原 — `.env.local` localhost URL 被烤進 production bundle + `fdgw.project.json::productionApi.viteApiBase` 還指向 staging,雙修;改走 `build-frontend-for-hosting.mjs`;新 bundle audit prod=1/staging=0/localhost=0;commit `4985321`;前版 v2.99)*

...
| 最後更新 README | 2026-04-16；細節見頁尾版本列與 [`docs/demo/README.md`](docs/demo/README.md)、[`docs/project/專案文件.md`](docs/project/專案文件.md) |
...
| 路徑        | 說明                                                                                                                                                                                                 |
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/finish` | 完成頁保證領獎原型（`FinishView.vue`）。規格與暫存鍵說明見 [`docs/project/專案文件.md`](docs/project/專案文件.md)「技術規格 → 前端」、[`docs/architecture/summary-frontend.md`](docs/architecture/summary-frontend.md) v1.2。 |
...
*README v2.7 · 2026-04-16（精簡與 `docs/demo`、`專案文件` 交叉引用；v2.6：Demo 內嵌）*
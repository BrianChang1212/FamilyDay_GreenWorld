...
| 最後更新 README | 2026-04-18（頁尾 **v2.37**）；細節見 [`docs/demo/README.md`](docs/demo/README.md)、[`docs/preview/`](docs/preview/)、[`docs/project/專案文件.md`](docs/project/專案文件.md) |
...
*README v2.37 · 2026-04-18（**標題**：瑞軒 2026 家庭日 — 解謎闖關遊戲（綠世界生態農場）；v2.36）*
...
*README v2.98 · 2026-06-02(報到表單需求修正:placeholder `1141041 → 1141157`、同行人數下拉擴成 `[0..N]` 預設「0 人 (沒有攜伴)」;後端 `partySize=0` 合法化、新增 `toNonNegativeInt` helper;三件一次部署、apiLoadtest smoke 三路徑全綠;commit `1efdbf6`;前版 v2.97)*

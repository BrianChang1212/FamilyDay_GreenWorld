...
*README v2.99 · 2026-06-02(briefing 頁文案＋6 站名重新命名:刪除頂部歡迎段、改第 1 條 gift bullet、stage 2~6 重命名【可愛動物區/雨林空中步道/羊駝之家/蝴蝶生態公園/鳥類生態公園】;三處同步【i18n / STAGE_NAMES / fdgw.project.json dashboard.stages】;三件部署 + live bundle hash 對上 + dashboard API 回新站名;commit `a470bf9`;前版 v2.98)*

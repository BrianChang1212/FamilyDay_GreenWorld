...
*README v2.92 · 2026-05-25（正式環境 roster 111 → 508 真實資料覆蓋 + 5 個 admin script 修正 production unnamed default db bug commit `05c667f` + 新增 `docs/setup/local-firestore-gcp.md` §E 正式環境 admin CLI runbook；前版 v2.91）*
